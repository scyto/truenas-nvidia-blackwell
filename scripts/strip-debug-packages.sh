...
#   - truenas_spdk — fails to build on GitHub runners, not needed for GPU
#
...
skip_sources = {'kernel-dbg', 'openzfs-dbg', 'scst-dbg', 'truenas_spdk'}
...
echo "Done. Removed: kernel-dbg, openzfs-dbg, scst-dbg, truenas_spdk"
